            ...
            <div className="lg:col-span-4 xl:col-span-4">
              <div>
                ...
                <p className="block text-sm text-gray-400 mb-9">
                  Sendexa is Ghana&apos;s leading messaging platform for developers and businesses. 
                  Send SMS, OTP, and Email APIs with reliable delivery and competitive pricing.
                </p>
        ...
        <div className="container relative z-10 px-5 mx-auto sm:px-7">
          <div className="flex flex-col sm:flex-row justify-between items-center py-5">
            ...
            <div className="mt-2 sm:mt-0">
              <p className="text-sm text-gray-500">
                A product of <span className="text-gray-400 font-medium">Xtottel</span>
              </p>
            </div>
          </div>
        </div>
