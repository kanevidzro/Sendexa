          ...
          <div className="flex items-center gap-4 justify-self-end">
            ...
            <Link
              ...
              // className="text-sm hidden lg:block font-medium text-gray-700 dark:text-gray-400 hover:text-primary-500"
               className="inline-flex items-center justify-center px-5 py-3 text-sm font-medium text-primary-500 border-2 border-primary/30 hover:border-primary-500 rounded-full transition"
            >
              Sign In
            </Link>
