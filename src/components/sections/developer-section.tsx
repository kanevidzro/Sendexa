...
import { GoIcon, NodeJSIcon, PhpIcon, JavaIcon, PythonIcon, RubyIcon } from '@/icons/icons';
...
const codeExamples = [
  ...
  -d '{
    ...
    features: ['Ghanaian number formatting', 'MTN/Telecel routing', 'Delivery reports']
  },
  {
    id: 'otp',
    language: 'curl',
...
const sdkLanguages = [
  { name: 'Node.js', icon: <NodeJSIcon />, docs: '/docs/node', version: 'v2.1.0', color: 'bg-green-50 dark:bg-green-500/10 text-green-600 dark:text-green-400 border-green-200 dark:border-green-500/20' },
  { name: 'Python', icon: <PythonIcon />, docs: '/docs/python', version: 'v1.8.0', color: 'bg-blue-50 dark:bg-blue-500/10 text-blue-600 dark:text-blue-400 border-blue-200 dark:border-blue-500/20' },
  { name: 'PHP', icon: <PhpIcon />, docs: '/docs/php', version: 'v3.2.0', color: 'bg-purple-50 dark:bg-purple-500/10 text-purple-600 dark:text-purple-400 border-purple-200 dark:border-purple-500/20' },
  { name: 'Java', icon: <JavaIcon />, docs: '/docs/java', version: 'v2.5.0', color: 'bg-red-50 dark:bg-red-500/10 text-red-600 dark:text-red-400 border-red-200 dark:border-red-500/20' },
  { name: 'Go', icon: <GoIcon />, docs: '/docs/go', version: 'v1.3.0', color: 'bg-cyan-50 dark:bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 border-cyan-200 dark:border-cyan-500/20' },
  { name: 'Ruby', icon: <RubyIcon />, docs: '/docs/ruby', version: 'v2.0.0', color: 'bg-pink-50 dark:bg-pink-500/10 text-pink-600 dark:text-pink-400 border-pink-200 dark:border-pink-500/20' },
];
...
export default function DeveloperSection() {
  ...
  const currentExample = codeExamples.find(ex => ex.id === activeExample) || codeExamples[0];
      ...
      <div className="wrapper px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto mb-8 md:mb-12 text-center">
          ...
          <p className="max-w-xl mx-auto text-sm md:text-base leading-relaxed text-gray-500 dark:text-gray-400 px-4">
            Powerful APIs, comprehensive documentation, and SDKs for every stack. 
            Integrate SMS, OTP, and Email in minutes.
          </p>
        </div>
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 md:gap-12">
              ...
              <div className="lg:sticky lg:top-24">
                <div className="mb-6 md:mb-8">
                  ...
                  <p className="text-sm md:text-base text-gray-600 dark:text-gray-400">
                    See how easy it is to integrate Sendexa into your application
                  </p>
                </div>
                ...
                <div className="bg-gray-900 rounded-xl overflow-hidden border border-gray-800">
                  <div className="flex items-center justify-between px-3 md:px-4 py-2 md:py-3 bg-gray-800">
                    ...
                    >
                      {copied ? (
                        <>
                          <HugeiconsIcon icon={CheckmarkCircle03Icon} className="w-3 h-3 md:w-4 md:h-4 mr-1" />
                          <span className="hidden sm:inline">Copied!</span>
                          <span className="inline sm:hidden">✓</span>
                        </>
                      ) : (
                        <>
                          <HugeiconsIcon icon={Copy01Icon} className="w-3 h-3 md:w-4 md:h-4 mr-1" />
                ...
                <div className="mt-4 md:mt-6">
                  ...
                  <div className="flex flex-wrap gap-1.5 md:gap-2">
                    {currentExample.features.map((feature, idx) => (
                      ...
                      >
                        <HugeiconsIcon icon={CheckmarkCircle03Icon} className="w-2.5 h-2.5 md:w-3 md:h-3 mr-1" />
                        <span className="truncate max-w-[120px] md:max-w-none">{feature}</span>
                      </span>
                    ))}
                  </div>
                </div>
            ...
            <div className="space-y-8 md:space-y-12">
              ...
              <div className="mt-6 md:mt-8 text-center">
                ...
                >
                  Get Your API Key
                  <HugeiconsIcon icon={ArrowMoveUpRightIcon} className="w-4 h-4 md:w-5 md:h-5 ml-2 md:ml-3" />
                </a>
        ...
        <div className="max-w-4xl mx-auto mt-12 md:mt-20 px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            <div className="text-center">
              <div className="text-2xl md:text-3xl font-bold text-primary-600 dark:text-primary-400 mb-1 md:mb-2">99.9%</div>
              <div className="text-xs md:text-sm text-gray-600 dark:text-gray-400">API Uptime</div>
            </div>
            <div className="text-center">
              <div className="text-2xl md:text-3xl font-bold text-primary-600 dark:text-primary-400 mb-1 md:mb-2">&lt;100ms</div>
              <div className="text-xs md:text-sm text-gray-600 dark:text-gray-400">Average Response</div>
            </div>
            <div className="text-center">
              <div className="text-2xl md:text-3xl font-bold text-primary-600 dark:text-primary-400 mb-1 md:mb-2">6</div>
              <div className="text-xs md:text-sm text-gray-600 dark:text-gray-400">SDK Languages</div>
            </div>
            <div className="text-center">
              <div className="text-2xl md:text-3xl font-bold text-primary-600 dark:text-primary-400 mb-1 md:mb-2">24/7</div>
              <div className="text-xs md:text-sm text-gray-600 dark:text-gray-400">Dev Support</div>
            </div>
          </div>
        </div>
      </div>
