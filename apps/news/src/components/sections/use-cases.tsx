...
const UseCaseCard: FC<{ useCase: UseCase; index: number }> = ({
  useCase,
  index,
}) => {
  ...
  return (
    ...
    >
      <div
        className={`inline-flex p-4 rounded-xl bg-gradient-to-r ${useCase.color} mb-6`}
      >
      ...
      <div className="wrapper">
        <div className="max-w-2xl mx-auto mb-12 text-center">
          ...
          <p className="max-w-xl mx-auto leading-6 text-gray-500 dark:text-gray-400">
            From banking to healthcare, Sendexa powers critical communications
            for businesses serving Ghana.
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            Don&apos;t see your industry? We customize solutions for unique
            needs.
          </p>
          <a
            href="/contact"
