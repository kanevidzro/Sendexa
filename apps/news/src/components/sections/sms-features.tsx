...
const features = [
  {
    ...
    details:
      "Our direct connections with MTN, Telecel, and AT ensure your messages reach their destination.",
  },
  // {
  //   title: "GHSMS Support",
  ...
  // },
  {
    ...
    details:
      "Plan your messages to be sent at specific times, even outside business hours.",
  },
  // {
      ...
      <div className="wrapper">
        <div className="max-w-2xl mx-auto mb-12 text-center">
          ...
          <p className="max-w-xl mx-auto leading-6 text-gray-500 dark:text-gray-400">
            Our platform is optimized for Ghana's unique telecommunications
            landscape, ensuring reliable delivery and maximum impact.
          </p>
        </div>
            ...
            <div className="bg-white dark:bg-white/5 rounded-3xl p-8 border border-gray-200 dark:border-white/10">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-900 dark:to-gray-800 rounded-2xl p-6">
                ...
                <div className="space-y-4">
                  {["MTN Ghana", "Telecel Ghana", "AT", "Glo Ghana"].map(
                    (network, i) => (
