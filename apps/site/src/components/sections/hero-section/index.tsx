        ...
        <div className="wrapper">
          <div className="max-w-[800px] mx-auto">
            <div className="text-center pb-16">
              <Subheading text="Ghana's Leading Communication Platform" />

              <h1 className="text-gray-700 mx-auto font-bold mb-4 text-4xl sm:text-[50px] dark:text-white/90 sm:leading-[64px] max-w-[700px]">
                Reliable SMS, OTP & Email Solutions for Ghanaian Businesses
              </h1>
              <p className="max-w-[537px] text-center mx-auto dark:text-gray-400 text-gray-500 text-base">
                Send bulk SMS, transactional messages, OTPs, and marketing emails 
                with 99.9% delivery rates. Built for Ghana's unique communication needs.
              </p>
          ...
          <div className="max-w-[1000px] mx-auto relative">
            <div className="p-3 sm:p-[18px] relative z-30 rounded-[32px] border border-white/30 dark:border-white/10 bg-white/20">
              <Image
                ...
                alt="Sendexa Dashboard showing SMS, OTP and Email management interface"
