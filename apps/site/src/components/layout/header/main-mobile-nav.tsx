          ...
          <div className="pt-2 pb-3 space-y-1 px-4 sm:px-6">
            {navItems.map((item) => {
                  ...
                  <Link
                    ...
                    className={cn(
                      'block px-4 py-3 rounded-lg text-base font-medium',
                      {
                        ...
                        'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800/50': !isActive,
                      }
                    )}
                  >
                    {item.label}
              ...
              if (item.type === 'dropdown') {
                const hasActiveChild = item.items.some((subItem) => pathname.includes(subItem.href));
                  ...
                  <div key={item.label}>
                    <button
                      ...
                      className={cn(
                        ...
                        {
                          'bg-primary-50 dark:bg-primary-900/20 text-primary-600 dark:text-primary-400': hasActiveChild,
                          'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800/50': !hasActiveChild,
                        }
                      )}
                    >
                              ...
                              {iconComponent && (
                                <div className={cn(
                                  'p-1.5 rounded-lg shrink-0',
                                  {
                                    ...
                                    'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400': !isSubActive,
                                  }
                                )}>
                                  {iconComponent}
                                </div>
